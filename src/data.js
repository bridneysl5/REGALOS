export const ALL_PRODUCTS = [
  ...
  { id: 6, name: 'Florero Superman - Batman', price: 40, category: ["Arreglos de Flores"], occasion: ["Aniversarios y Parejas","Para Él","Para Ella"], img: '/images/Aniversario_Parejas/florero Superman - Batman.webp' },
  { id: 7, name: 'Box Hot Wheels', price: 70, category: ["Sets y Gift Boxes"], occasion: ["Para Él","Para Él"], img: '/images/DIA DEL PADRE - EL/box Hot wheels.webp', details: ['Dos hot wheels', 'Una caja de Ferrero Rocher', 'Snack de frutos secos o gomitas', 'Vaso hot wheels', 'Carta personalizada'] },
  { id: 8, name: 'Box Best Padre 1', price: 100, category: ["Sets y Gift Boxes"], occasion: ["Para Él"], isTop: true, img: '/images/DIA DEL PADRE - EL/box best padre 1.webp', details: ['Taza térmica personalizada', 'Postre', 'HotCakes con fruta o pan con pollo', 'Carta personalizada con tu mensaje especial', 'Chocolates Ferrero Rocher', 'Cuadro personalizado'] },
  { id: 9, name: 'Box Best Padre 2', price: 89, category: ["Sets y Gift Boxes"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/box best padre 2.webp', details: ['Jugo de maracuyá', 'Vaso con postre', 'Pan con pollo', 'Torta en frasco personalizado', 'Ensalada de frutas', 'Carta personalizada', 'Tequeños'] },
  { id: 10, name: 'Box Padre Star Wars 1', price: 65, category: ["Sets y Gift Boxes"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/box padre Star Wars 1.webp', details: ['Una libreta "Yo soy tu padre"', 'Un frasco de alfajores', 'Una taza personalizada', 'Una carta personalizada', 'Un snack personalizado', 'Queque o tequeños'] },
  { id: 11, name: 'Box Padre Star Wars 2', price: 85, category: ["Sets y Gift Boxes"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/box padre Star Wars 2.webp', details: ['2 fotos polaroid personalizadas', 'Una cerveza', 'Un snack', 'Queque o tequeños', 'Pringles', 'Carta personalizada'] },
  { id: 12, name: 'Box Padre Star Wars 3', price: 100, category: ["Sets y Gift Boxes"], occasion: ["Para Él"], isTop: true, img: '/images/DIA DEL PADRE - EL/box padre Star Wars 3.webp', details: ['Un jugo de maracuyá o chicha morada', 'Una taza personalizada Star Wars', 'Una dona', 'Chocolate Ferrero', 'Pan con pollo', 'Queque o tequeños', 'Carta personalizada'] },
  { id: 13, name: 'Box Padre Superheroe', price: 89, category: ["Sets y Gift Boxes"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/box padre Superheroe.webp', details: ['Una cerveza "Feliz día del padre"', 'Un vaso cervecero día del padre', 'Pringles', 'Kit de galletas', 'Ferrero Rocher', 'Caja de dulces'] },
  { id: 14, name: 'Box Padre Globos 1', price: 165, category: ["Sets y Gift Boxes","Tortas y Repostería"], occasion: ["Para Él","Cumpleaños"], img: '/images/DIA DEL PADRE - EL/box padre globos 1.webp', details: ['Una caja de Ferrero Rocher', 'Una copa con ensalada de frutas o postre', 'Bebida de maracuyá o chicha morada', 'Una bebida chocolatada', 'Tequeños', 'Flores', 'Torta personalizada día del padre', 'Carta personalizada'] },
  { id: 15, name: 'Box Padre Globos 2', price: 149, category: ["Sets y Gift Boxes"], occasion: ["Para Él","Cumpleaños"], img: '/images/DIA DEL PADRE - EL/box padre globos 2.webp', details: ['Torta personalizada día del padre', 'Vaso cervecero día del padre', 'Un frasco con frutos secos o gomitas', '5 cervezas Corona', 'Una carta personalizada'] },
  { id: 16, name: 'Box Padre Personalizado 1', price: 75, category: ["Sets y Gift Boxes"], occasion: ["Para Él","Para Él"], img: '/images/DIA DEL PADRE - EL/box padre personalizado 1.webp', details: ['1 vino personalizado con foto', 'Un vaso térmico personalizado con sus nombres', 'Un cuadro personalizado', 'Caja de Ferrero Rocher', 'Una carta personalizada'] },
  { id: 17, name: 'Box Padre Personalizado 2', price: 59, category: ["Sets y Gift Boxes"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/box padre personalizado 2.webp', details: ['3 cervezas Corona', 'Un vaso térmico personalizado', 'Un frasco con frutos secos o gomitas', 'Un cuadro personalizado', 'Una carta personalizada'] },
  { id: 18, name: 'Taza Padre Personalizado 1', price: 20, category: ["Todos","Sets y Gift Boxes"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/taza  padre personalizado 1.webp', details: ['Taza con imagen del dibujo'] },
  { id: 19, name: 'Torta Padre 1', price: 69, category: ["Para Él","Tortas y Repostería"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/torta padre 1.webp', details: ['Torta personalizada', '2 sabores a escoger (chocolate, vainilla)', '3 fotos polaroid'] },
  ...
  { id: 26, name: 'Torta Stich', price: 110, category: ["Tortas y Repostería"], occasion: ["Para Ella","Para Él","Aniversarios y Parejas","Cumpleaños"], img: '/images/Para Ella/Torta Stich.webp' },
  ...
  { id: 34, name: 'Estante En Miniatura', price: 107, category: ["Cuadros"], occasion: ["Para Él","Cumpleaños"], img: '/images/DIA DEL PADRE - EL/Estante en miniatura.webp', details: ['5 fotos personalizadas', 'Fecha personalizada', 'Libros personalizados'] },
  { id: 35, name: 'Imán Cuadro En Miniatura 1', price: 122, category: ["Cuadros"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/Imán cuadro en miniatura 1.webp', details: ['3 fotos personalizadas', 'Fecha o frase personalizada'] },
  { id: 36, name: 'Imán Cuadro En Miniatura 2', price: 117, category: ["Cuadros"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/Imán cuadro en miniatura 2.webp', details: ['3 fotos personalizadas', 'Libros personalizados'] },
  { id: 37, name: 'Imán Cuadro En Miniatura 3', price: 113, category: ["Cuadros"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/Imán cuadro en miniatura 3.webp' },
  ...
  { id: 47, name: 'Fifa', price: 100, category: ["Sets y Gift Boxes"], occasion: ["Aniversarios y Parejas","Para Él"], img: '/images/Aniversario_Parejas/Fifa.webp' },
  { id: 48, name: 'Hot Wheel 1', price: 100, category: ["Sets y Gift Boxes"], occasion: ["Aniversarios y Parejas","Para Él"], img: '/images/Aniversario_Parejas/Hot Wheel 1.webp' },
  ...
  { id: 52, name: 'Pintura y vino', price: 100, category: ["Sets y Gift Boxes"], occasion: ["Aniversarios y Parejas","Para Ella","Para Él","Cumpleaños"], img: '/images/Aniversario_Parejas/Pintura y vino.webp' },
  ...
  { id: 56, name: 'Box padre google', price: 100, category: ["Sets y Gift Boxes"], occasion: ["Para Él"], img: '/images/DIA DEL PADRE - EL/box padre google.webp', details: ['Un carro hot wheels personalizado con foto', 'Una copa del mejor papá', 'Un llavero personalizado', 'Snack de dulces', 'Una carta personalizada'] },
  { id: 57, name: 'Box padre universitario', price: 50, category: ["Sets y Gift Boxes"], occasion: ["Para Él","Para Él"], isCheap: true, img: '/images/DIA DEL PADRE - EL/box padre universitario.webp', details: ['Una cerveza personalizada', 'Dos fotos polaroid personalizadas', 'Pringles personalizado', 'Una carta personalizada'] },
  ...
  { id: 75, name: 'Ramo 5 Girasoles Eternos', price: 97, category: ['Arreglos de Flores'], occasion: ['Flores Amarillas'], img: '/images/Flores Amarillas/ramo 5 girasoles eternos.webp' },

  { id: 76, name: 'Ramo Girasol Burbuja', price: 104, isTop: true, category: ['Arreglos de Flores'], occasion: ['Flores Amarillas'], img: '/images/Flores Amarillas/Ramo girasol burbuja.webp' },
  { id: 77, name: 'Ramo Girasol Van Gogh Con Mariposas', price: 102, category: ['Arreglos de Flores'], occasion: ['Flores Amarillas'], img: '/images/Flores Amarillas/Ramo girasol Van Gogh con mariposas.webp' },
  { id: 78, name: 'Ramo Girasol', price: 105, category: ['Arreglos de Flores'], occasion: ['Flores Amarillas'], img: '/images/Flores Amarillas/Ramo Girasol.webp' },
